...
if ($conexion->connect_errno) {
  ...
  echo 'Conexión OK!!';// solo para pruebas
}
// HACEMOS LA CONSULTA, O BIEN TRAEMOS TODO Y LUEGO HACEMOS UN BUCLE O BIEN APUNTAMOS FINO CON UN WHERE
...
// comprobamos las filas importadas
echo 'filas importadas: ' . mysqli_num_rows($resultados) . '<br>';
